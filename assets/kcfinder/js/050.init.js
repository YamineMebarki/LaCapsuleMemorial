...
_.setTitle = function(title) {
    ...
    if (_.opener.name == "tinymce")
        ...
        ifr.parent().parent().find('div.mce-title').html('<span style="padding:0 0 0 28px;margin:-2px 0 -3px -6px;display:block;font-size:1em;font-weight:bold;background:url(' + path + 'themes/default/images/kcf_logo.png) left center no-repeat">' + title + '</span>');
    }
};
